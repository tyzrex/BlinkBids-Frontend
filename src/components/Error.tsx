export default function ErrorComponent(props: { error: any; message: string }) {
  return (
    <>
      <div className="w-full h-full py-10 flex gap-10 flex-col items-center justify-center">
        <svg
        ...
        >
          ...
          <rect
            ...
            fill="currentColor"
          ></rect>
          <circle cx="316.60911" cy="538" r="79" fill="#2c6bb3"></circle>
          <rect
            x="280.60911"
            y="600"
            width="24"
          ...
          <circle cx="318.60911" cy="518" r="9" fill="#f38434"></circle>
          <path
        ...
        <div className="flex flex-col gap-5 items-center justify-center">
          <p className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-wider text-gray-600 mt-8">
            {props.error}
          </p>
          <p className="text-2xl md:text-3xl lg:text-3xl font-bold text-gray-600 mt-2">
